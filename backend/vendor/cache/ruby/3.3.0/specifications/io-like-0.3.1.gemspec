...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<mspec>.freeze, ["~> 1.5".freeze])
  s.add_development_dependency(%q<yard>.freeze, ["~> 0.8".freeze])
  s.add_development_dependency(%q<yard-redcarpet-ext>.freeze, ["~> 0.0".freeze])
  s.add_development_dependency(%q<github-markup>.freeze, ["~> 1.2".freeze])
end
